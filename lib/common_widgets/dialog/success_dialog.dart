  ...
  showAnimatedDialog(context: context, builder: (context) => AlertDialog(
    icon: Container(
        ...
        child: Padding(
          ...
          child: Image.asset("assets/images/success.png", fit: BoxFit.contain, height: 50, width: 50,),
        )),
    title: Text(title,
      style: const TextStyle(color: Colors.green, fontFamily: 'Manrope', fontWeight: FontWeight.bold, fontSize: 18.0),),
    content: Padding(
      padding: const EdgeInsets.all(8.0),
      child: Text(
        description,
        textAlign: TextAlign.center,
        style: const TextStyle(color: Colors.grey, fontFamily: 'Manrope', fontSize: 16.0),
      ),
    ),
