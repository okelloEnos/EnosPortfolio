...
//
//       return AlertDialog(
//         title: Center(child: Text(title, style: const TextStyle(fontFamily: 'Manrope', fontSize: 20.0, color: colorPrimaryDark),)),
//         content: Text( description,  style: const TextStyle(fontFamily: 'Manrope', fontSize: 16.0, color: colorPrimaryDark),),
//       );
//     },
...
//
//       return AlertDialog(
//         title: Center(child: Text(title, style: const TextStyle(fontFamily: 'Manrope', fontSize: 20.0, color: colorPrimaryDark, fontWeight: FontWeight.bold),)),
//         content: const Text("coming_soon_text",  style: TextStyle(fontFamily: 'Manrope', fontSize: 16.0, color: colorPrimaryDark),),
//       );
//     },
...
//       return
//         SimpleDialog(
//           title: const Center(child: Text("submission_failed_text", style: TextStyle(color: colorPrimaryDark, fontFamily: 'Manrope', fontWeight: FontWeight.bold),)),
...
//                     style: TextStyle(color: colorPrimaryDark, fontFamily: 'Manrope', fontWeight: FontWeight.bold, fontSize: 16.0),
//                   ),
//                 ),
//               ),
//       Align(
...
//         style: const TextStyle(color: colorPrimaryDark, fontFamily: 'Manrope', fontSize: 15.0),
//         ),
//         ),
//       ),
//             ]
...
//       return
//         SimpleDialog(
//             title: Center(child: Text(title, style: const TextStyle(color: colorPrimaryDark, fontFamily: 'Manrope', fontWeight: FontWeight.bold),)),
//             contentPadding: const EdgeInsets.all(8.0),
//             children: [
//               const Divider(),
//               const SizedBox(height: 5.0,),
