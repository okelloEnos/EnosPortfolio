...
// Content:
//
// Grouped categories — e.g., Frontend, Backend, Mobile, Tools.
//
// Optionally animated progress indicators or hover effects.
//
// Tool logos (Flutter, Dart, Firebase, etc.).
class SkillSection extends StatelessWidget {
  final double width;
  final double height;
  const SkillSection({required this.width, required this.height, Key? key})
      : super(key: key);
